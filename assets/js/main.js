...
const selectedIcon =  localStorage.getItem('icon-theme')
...
if (selectedTheme) {
    // If the validation is fullfilled, we ask what the issue was to know if we activate or deactivate the dark
